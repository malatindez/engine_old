...
class Model {
  ...
  // copy constructor
  Model(const Model&) noexcept : textureManager(nullptr) {}

  // move constructor
  Model(Model&&) noexcept : textureManager(nullptr) {}
...
#define load_textures_from_material(x, y)   \
  ...
  textures.insert(textures.end(), z.begin(), z.end());
      ...
      load_textures_from_material(aiTextureType_UNKNOWN,
                                  Texture::Type::DIFFUSE);
      load_textures_from_material(aiTextureType_DIFFUSE,
                                  Texture::Type::DIFFUSE);
      load_textures_from_material(aiTextureType_SPECULAR,
                                  Texture::Type::SPECULAR);
      load_textures_from_material(aiTextureType_AMBIENT,
                                  Texture::Type::AMBIENT);
      load_textures_from_material(aiTextureType_EMISSIVE,
                                  Texture::Type::EMISSIVE);
      load_textures_from_material(aiTextureType_HEIGHT, Texture::Type::HEIGHT);
      load_textures_from_material(aiTextureType_NORMALS,
                                  Texture::Type::NORMALS);
      load_textures_from_material(aiTextureType_SHININESS,
                                  Texture::Type::SHININESS);
      load_textures_from_material(aiTextureType_OPACITY,
                                  Texture::Type::OPACITY);
      load_textures_from_material(aiTextureType_DISPLACEMENT,
                                  Texture::Type::DISPLACEMENT);
      load_textures_from_material(aiTextureType_LIGHTMAP,
                                  Texture::Type::LIGHTMAP);
      load_textures_from_material(aiTextureType_REFLECTION,
                                  Texture::Type::REFLECTION);
      load_textures_from_material(aiTextureType_BASE_COLOR,
                                  Texture::Type::BASE_COLOR);
      load_textures_from_material(aiTextureType_NORMAL_CAMERA,
                                  Texture::Type::NORMAL_CAMERA);
      load_textures_from_material(aiTextureType_EMISSION_COLOR,
                                  Texture::Type::EMISSION_COLOR);
      load_textures_from_material(aiTextureType_METALNESS,
                                  Texture::Type::METALNESS);
      load_textures_from_material(aiTextureType_DIFFUSE_ROUGHNESS,
                                  Texture::Type::DIFFUSE_ROUGHNESS);
      load_textures_from_material(aiTextureType_AMBIENT_OCCLUSION,
  ...
  std::vector<std::shared_ptr<Texture>> loadMaterialTextures(
      aiMaterial* mat, aiTextureType type, Texture::Type textureType) {
    std::vector<std::shared_ptr<Texture>> textures;
    ...
    for (unsigned int i = 0; i < mat->GetTextureCount(type); i++) {
      ...
      std::shared_ptr<Texture> texture =
          textureManager->Load(std::string(str.C_Str()), v, textureType);
