...
public:
    enum class exceptions { FRAGMENT_COMPILATION_ERROR, VERTEX_COMPILATION_ERROR, GEOMETRY_COMPILATION_ERROR, PROGRAM_COMPILATION_ERROR };
    ShaderProgram(std::string vertexShaderCode, std::string fragmentShaderCode, std::string geometryShaderCode = "");
