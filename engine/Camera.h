...
public:
    ...
    void setConstrainPitch(bool cp = true) noexcept {
        constrainPitch = cp;
    }
    bool getConstrainPitch() const noexcept {
        return constrainPitch;
    }
    float getYaw() const noexcept {
        return this->yaw;
    }
    void setYaw(const float value) noexcept {
        this->yaw = value;
    }
    float getPitch() const noexcept {
        return this->pitch;
    }
    void setPitch(const float value) noexcept {
        this->pitch = value;
    }
    float getSensivity() const noexcept {
        return this->sensivity;
    }
    void setSensivity(const float value) noexcept {
        this->sensivity = value;
    }
    float getFOV() const noexcept {
        return this->fov;
    }
    void setWorldUp(const glm::vec3 value) noexcept {
        this->worldUp = value;
    }
